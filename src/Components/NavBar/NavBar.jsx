        ...
        <div className="container flex items-center gap-10 px-3">
          ...
          {token && (
            <>
              ...
              <Link
                to={"/cart"}
                className="hidden md:inline-block cart cursor-pointer ml-auto relative"
              >
              ...
              <Link to={"/wishlist"} className="hidden md:inline-block cart cursor-pointer  relative">
          ...
          <ul className={`hidden md:flex items-center gap-5 ${!token && "ml-auto"}`}>
            <li>
              <Link>
          ...
          <ul className="flex items-center gap-5 ml-auto md:m-0 ">
            ...
            {token && (
              ...
              <div className={`absolute bg-slate-100 top-10 z-50 w-52 right-0 md:right-0 rounded-md ${isMenuHidden} `}>
              <ul className="flex flex-col justify-center items-center gap-3 text-slate-700">
                    <li className="border-solid border-b border-slate-600 w-full text-center py-2  ">
                      <Link to={"/"}>Home</Link>
                    </li>
